...
const buf = fs.readFileSync("./__tests__/data/little.nii.gz");
...
describe('NIFTI-Reader-JS', function () {
    describe('nifti-1 little endian test', function () {
        ...
        it('littleEndian should be true', function () {
            chai_1.assert.equal(true, nifti1.littleEndian);
        });
        ...
        it('image data checksum should equal 4006845507', function () {
            ...
            chai_1.assert.equal(checksum, 4006845507);
        });
    });
});
//# sourceMappingURL=nifti1-little.spec.js.map